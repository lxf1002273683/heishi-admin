    ...
    <div class="goodsAddForm">
      <el-form label-width="80px" :model="addForm" ref="addForm" :rules="rules">
        ...
        <el-form-item label="SKU" prop="sku_id">
          <el-select v-model="skuOptions" clearable filterable remote placeholder="请输入SPU查询" :remote-method="remoteMethod" :loading="loading"  @change="selectChange" class="select_sku_id">
      ...
      <el-table :data="addTable" style="width: 100%" stripe border>
        <el-table-column type="expand">
          <template scope="props">
            <el-form label-position="left" inline class="addTable">
              <el-form-item label="SKU："><span>{{ props.row.sku_name }}</span></el-form-item>
              <el-form-item label="仓库："><span>{{ props.row.warehouse_name }}</span></el-form-item>
              <el-form-item label="商品进价："><span>{{ props.row.purchasing_price }}</span></el-form-item>
        ...
        <el-table-column prop="sku_name" label="SKU" width="120"></el-table-column>
